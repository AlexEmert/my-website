...
```{python}
print(nfl_fg_clean.shape)
```

There are 3000 observations and 20 features, including the target.
...
```{python}
print(f"The average number of field goals in this data set made is: "{nfl_train["Made"].mean()})
```
