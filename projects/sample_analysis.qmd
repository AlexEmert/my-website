...
Additionally, all categorical variables are already in the form we need (dummy coded) to those can be passed through for now.

```{python}
cat_vars = ['Home', 'Indoor', 'Grass', 'Playoff', 'Backup']
num_vars = ['Dist', 'Stadium #', 'Time', 'Qtr', 'Marg', 'Temp', 'Precip', 'Dewpt', 'Humidity', 'H/T-wind', 'C-wind', 'Altitude', 'Wind', 'Def PA']
